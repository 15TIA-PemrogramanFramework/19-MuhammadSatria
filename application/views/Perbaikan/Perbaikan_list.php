...
<div class="row">
	<div class="col-md-12 text-right" style="margin-top:20px;margin-bottom:20px">
		<?php
		echo anchor(site_url("Perbaikan/tambah_perbaikan"),'<i class ="fa fa-plus"></i>Tambah Data','class="btn btn-primary"');?>
	</div>
</div>
<div class="content">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="header">
						<h4 class="title">Data Perbaikan</h4>
						<br>
										...
										<table id="example1" class="table table-bordered table-hover">
											...
											<thead>
												...
												<th style="text-align:center; vertical-align:middle;">No</th>
													...
													<th style="text-align:center; vertical-align:middle;">Nama Pemilik</th>
											...
											<tbody>
												<?php foreach ($perbaikan as $key => $value) {?>
													<tr>
														...
														<td align="center" style="vertical-align:middle;"><?php echo $value->tanggal_service; ?></td>
														...
														<td align="center" style="vertical-align:middle;"><?php echo $value->merk_barang; ?></td>
														<td align="center" style="vertical-align:middle;"><?php echo $value->jenis_kerusakan; ?></td>
														<td align="center" style="vertical-align:middle;"><?php echo $value->nama_pemilik; ?></td>
														...
														<td align="center" style="vertical-align:middle;">
															<?php echo anchor(site_url('Perbaikan/edit/'.$value->kode_service),
																'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>',
																'class="btn btn-warning"'); ?>

															<?php echo anchor(site_url('Perbaikan/delete/'.$value->kode_service),
